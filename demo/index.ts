import { action, Button, Card, defaultCard, DialogActionAfterSubmit, dropdown, input, list, loginCard, modernCard, multiStateSwitch, noteCard, PageTitle, RenderingX, richCard, searchCard, SearchMode, span, SupportedThemes, switchButtons, Title, WebGen } from '../src/webgen';
...
var web = WebGen({
    ...
    theme: SupportedThemes.auto,
    image: () => 'https://picsum.photos/1920/1080'
});

const render = new RenderingX();

const testDialog = render.toDialog({
    title: "Hello World",
...
const body = render.toBody({ maxWidth: "50rem" }, {
    switchDisable: false,
    switchChecked: false,
    replace: true,
    theme: 0
...
web.theme.updateTheme(SupportedThemes.auto)